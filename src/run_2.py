...
T, depth, p, depth_intercepts = calculate_hasterok2011_geotherm(SHF = 42.2, BDL_T = 800+273, T_0 = 0, max_depth = 300, moho = 38, kinked = False, adiabat = True)

mantle_geotherm_plot(T = T, P = p, Depth = depth, plot_style = 'Depth', Temp_unit = 'Celsius', T_Sample = T_garnet, P_Sample = P_garnet, T_std = 50, P_std = 0.1, plot_type = 'show', max_depth = 300, moho = 38, lab = 220)
