...
class test_cpx_liq_melt_matching(unittest.TestCase):
    def test_eq33_P2017_press(self):
        self.assertAlmostEqualcalculate_cpx_liq_press_temp_matching(cpx_comps=Cpx2, liq_comps=Liq2,
equationT="T_Put2008_eq33", equationP="P_Neave2017", KdErr=0.11, eq_crit="All",
Fe3FeT_Liq=0.0, sigma=4).get("Av_PTs").Mean_P_kbar_calc, 5.993997, decimalPlace,
       "Calc T from melt matching eq33-N2017 not equal to test value")

    def test_eq33_P2017_press(self):
        self.assertAlmostEqualcalculate_cpx_liq_press_temp_matching(cpx_comps=Cpx2, liq_comps=Liq2,
equationT="T_Put2008_eq33", equationP="P_Neave2017", KdErr=0.11, eq_crit="All",
Fe3FeT_Liq=0.0, sigma=4).get("Av_PTs").Mean_T_K_calc, 1480.039007, decimalPlace,
       "Calc T from melt matching eq33-N2017 not equal to test value")
